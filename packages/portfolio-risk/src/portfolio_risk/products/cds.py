...
from ..core.config import (CURVE_BUMP, N_PATHS_SENS, N_STEPS, SEED, SWAP_TENORS,
                     VOL_BUMP)
from ..core.conventions import BDC, Calendar, DayCount, gen_schedule
from ..products.corp import corp_pv, corp_solve_oas
from ..core.curve import bootstrap_curve, forwards_from_dfs
from ..core.kernels import _fsig
    ...
    def __init__(self, book: pl.DataFrame, asof: dt.date,
        ...
        for r in rows:
            ...
            if freq <= 0:                      # interest at maturity
                ...
                from ..core.conventions import year_fraction
                sched = [(asof, pay, pay,
