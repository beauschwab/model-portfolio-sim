"""portfolio-risk: layered package (v0.17 reorg).
...
unitlib+optimizer. Old flat paths (portfolio_risk.kernels, portfolio_risk.corp, ...)
...
for _m in (config, conventions, curve, interfaces, kernels, lmm, pricing,
           ...
           unitlib):
    _sys.modules["portfolio_risk." + _m.__name__.rsplit(".", 1)[-1]] = _m
